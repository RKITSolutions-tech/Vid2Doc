"""SQLAlchemy models for Slides and TextExtracts (packaged).

This is a direct move from the repository root into the `vid2doc` package
so the models are available as `vid2doc.models_sqlalchemy`.
"""
import os
