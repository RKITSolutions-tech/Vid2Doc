"""Video processing utilities (moved into package).

This module mirrors the root `video_processing.py` implementation and is
intended to be the canonical location for imports once the project fully
migrates into the `vid2doc` package.
"""
try:
    import cv2
    import numpy as np
