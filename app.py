...
"""Flask web application for video documentation"""
from flask import (
    Flask,
    render_template,
    request,
...
from video_processor import VideoProcessor, PREVIEW_FRAME_INTERVAL
from video_processing import get_video_properties
...
def api_health():
    return jsonify({'success': True, 'status': 'ok', 'time': time.time()})
